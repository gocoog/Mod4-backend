...
e1 = Election.create(election_name: Faker::Name.name , img_url: Faker::Avatar.image, election_desc: Faker::Lorem.paragraph(sentence_count: 2), election_type: "popular", election_end_date: '12-12-2020', number_of_votes: 0, user: u1)
e2 = Election.create(election_name: Faker::Name.name , img_url: Faker::Avatar.image, election_desc: Faker::Lorem.paragraph(sentence_count: 2), election_type: "popular", election_end_date: '12-12-2020', number_of_votes: 0, user: u1)
e3 = Election.create(election_name: Faker::Name.name , img_url: Faker::Avatar.image, election_desc: Faker::Lorem.paragraph(sentence_count: 2), election_type: "popular", election_end_date: '12-12-2020', number_of_votes: 0, user: u1)
...
e5 = Election.create(election_name: Faker::Name.name , img_url: Faker::Avatar.image, election_desc: Faker::Lorem.paragraph(sentence_count: 2), election_type: "popular", election_end_date: '12-12-2020', number_of_votes: 0, user: u3)
